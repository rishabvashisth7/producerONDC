...
@RestController
@RequestMapping("/api/bapondc-kafka")
public class BapondcKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BapondcKafkaResource.class);
    ...
    public BapondcKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
